...
public class UserInfoListActivity extends AppCompatActivity {
    ...
    public void clearUserInfo(){
        UserInfoList info = (UserInfoList) preference.read(UserInfoListActivity.EXTTRA_LIST, UserInfoList.class);
        info.getUserInfoList().clear();
        adapter.setData(info.getUserInfoList());
        preference.save(UserInfoListActivity.EXTTRA_LIST, info);
        textNotFound.setVisibility(View.VISIBLE);
        list.setVisibility(View.GONE);
        adapter.notifyDataSetChanged();
